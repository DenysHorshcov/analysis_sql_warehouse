...
-- 2) Customers (з bronze/silver → gold.dim_customers)
...
-- 3) Products (SCD current rows → gold.dim_products)
...
LEFT JOIN silver.erp_px_cat_g1v2 AS pc
  ON pn.cat_id = pc.id
WHERE pn.prd_end_dt = DATE '9999-12-31' OR pn.prd_end_dt IS NULL;

-- 4) Fact Sales (лінкує на виміри)
